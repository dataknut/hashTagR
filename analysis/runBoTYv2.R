...
oDfile <- paste0("~/Data/twitter/boty2018/raw/tw_", searchString,"_", lubridate::now(),".csv") # <- data file
...
rmdFile <- paste0(projLoc, "/analysis/boty2018.Rmd") # <- the Rmd code to render

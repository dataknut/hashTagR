...
Figure \@ref(fig:plotHashtags) plots the daily occurence of these hashtags after removing variants of `#birdOfTheYear` and `#boty` and selecting only those which have more than `r threshold` mentions on any day. See Section \@ref(problems) for the problems with this approach.
...
# Problems with counting #hashtags {#problems}

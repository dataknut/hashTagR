...
# First we remove the macrons so that TeamKakī == TeamKaki & takahe == takahē etc 
...
htLongDT <- htLongDT[, htClean := gsub("team", "",htClean)] # remove 'team' from a string so that e.g. teamkaki == kaki
```

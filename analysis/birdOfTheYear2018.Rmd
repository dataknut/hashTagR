...
This is very quick and dirty but... Table \@ref(tab:tweetTable) shows the total count of each #hashtag with thanks to [David Hood](https://twitter.com/Thoughtfulnz/status/1046685305569345536) for code to help make sure that kakī != kaki.
